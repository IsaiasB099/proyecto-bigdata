...
Un script Python que lee staging.nomina y verifica que los datos sean confiables antes de analizar.
...
## Cómo ejecutar — en /opt/repo/proyecto-bigdata/scripts/python
python3 02_validar_calidad_nomina.py, dependencias, variables de entorno (.env)